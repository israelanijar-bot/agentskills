            ...
            <div className="lg:col-span-2">
              <div className="sticky top-24">
                ...
                <div className="flex items-center gap-3 mb-8">
                  <Link
                    href={isFree ? "/compra/sucesso" : `/checkout/${product.slug}`}
                    className="flex-1 px-6 py-4 bg-accent-500 text-white font-bold rounded-xl hover:bg-accent-600 transition-colors text-lg text-center"
                  >
