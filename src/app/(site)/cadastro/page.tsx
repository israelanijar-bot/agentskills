        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-ink-500 mb-6">
              ...
              <strong className="text-ink-700">{email}</strong>. Clique no link
              para ativar sua conta.
            </p>
            <Link
              href="/login"
              className="inline-block px-6 py-3 bg-accent-500 text-white font-semibold rounded-xl hover:bg-accent-600 transition-colors"
            >
              Voltar ao login
            </Link>
          </div>
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-ink-900">Crie sua conta</h1>
            <p className="text-ink-500 mt-1">
              Comece a explorar skills para seus agentes
            </p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-ink-500">ou</span>
            </div>
          </div>
          ...
          <p className="text-center text-xs text-ink-500 mt-4">
            ...
            <Link href="/termos" className="text-accent-500 hover:underline">
              Termos de Uso
            </Link>{" "}
            e{" "}
            <Link href="/privacidade" className="text-accent-500 hover:underline">
